...
func _enter_tree():
	##### BOTTLED
	add_custom_type("BottledTileMap", "TileMap", preload("res://addons/BottledTileMap/BottledTilemap.gd"), preload("res://addons/BottledTileMap/plugin_icon.png"))
#	##### TILECELL
...
###### TILECELL
#
#const sceneTileCells = preload("res://addons/BottledTileMap/TileCellManager/TileCells.gd")
...
#
#const TileMapInspectorPlugin = preload("res://addons/BottledTileMap/nklbdev.tile_palette/tilemap_inspector-plugin.gd")
#
